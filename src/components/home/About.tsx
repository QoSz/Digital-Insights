    ...
    return (
        <section className="py-12 px-4 md:px-6 lg:px-8 bg-gray-50 dark:bg-gray-900">
            <div className="max-w-7xl mx-auto">
                <h2 className="text-3xl font-bold mb-8 text-center text-[#0070c0]">About DigitAI Insights</h2>
                ...
                <div className="grid grid-cols-1 gap-8 mb-12">
                    {[
                        ...
                        <div key={leader.name} className="flex flex-col md:flex-row bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md border-t-4 border-[#0070c0]">
                ...
                <div className="mb-12">
                    ...
                    <div className="flex flex-wrap justify-center gap-8 text-center">
                        {[
                            ...
                            <div key={office.location} className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border-t-4 border-[#0070c0] w-64">
